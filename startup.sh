...
tmux new-session -d -s model_app3 'export MODEL_ID="stabilityai/stable-diffusion-2-1"; export TPU_HOST_BOUNDS="1,1,1"; export TPU_CHIPS_PER_HOST_BOUNDS="1,2,1"; export TPU_VISIBLE_DEVICES="2"; export TPU_MESH_CONTROLLER_ADDRESS="localhost:8478"; export TPU_MESH_CONTROLLER_PORT="8478"; python3 -m gunicorn -t 300 -b :5002 -w 1 -k uvicorn.workers.UvicornWorker api:app'
