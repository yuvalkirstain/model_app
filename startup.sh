...
tmux new-session -d -s model_app_start 'export MODEL_ID="runwayml/stable-diffusion-v1-5"; export TPU_VISIBLE_DEVICES="0,1"; export TPU_MESH_CONTROLLER_ADDRESS="localhost:8476"; export TPU_MESH_CONTROLLER_PORT="8476"; python3 -m gunicorn -t 300 -b :5000 -w 1 -k uvicorn.workers.UvicornWorker api:app'
